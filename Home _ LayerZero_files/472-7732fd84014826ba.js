    ...
    2873: function (e, t, s) {
        ...
        return (
          i.Children.toArray(e).forEach(e => {
            e.type && 'SwiperSlide' === e.type.displayName
              ? t.push(e)
              : e.props && e.props.children && f(e.props.children).forEach(e => t.push(e))
          }),
          t
        )
      }
      ...
      function m({ swiper: e, slides: t, passedParams: s, changedParams: i, nextEl: n, prevEl: l, scrollbarEl: o, paginationEl: d }) {
            ...
            if (r(p[t]) && r(s[t])) a(p[t], s[t])
              ...
              ;(!0 !== n && !1 !== n) || ('navigation' !== t && 'pagination' !== t && 'scrollbar' !== t)
                ...
                : !1 === n &&
                  ...
                  (e[i].destroy(),
                  'navigation' === i
                    ? ((p[i].prevEl = void 0), (p[i].nextEl = void 0), (e[i].prevEl = void 0), (e[i].nextEl = void 0))
        ...
        w && (e.controller.control = p.controller.control),
          ...
          y && (o && (p.scrollbar.el = o), h.init(), h.updateSize(), h.setTranslate()),
          S && (n && (p.navigation.nextEl = n), l && (p.navigation.prevEl = l), f.init(), f.update()),
      ...
      const w = (0, i.forwardRef)(({ className: e, tag: t = 'div', wrapperTag: s = 'div', children: f, onSwiper: w, ...b } = {}, y) => {
        ...
        if (
          ...
          const e = { cache: !1, slides: F, renderExternal: x, renderExternalUpdate: !1 }
          a(O.current.params.virtual, e), a(O.current.originalParams.virtual, e)
        }
        O.current && O.current.on('_beforeBreakpoint', H)
        return (
          (0, i.useEffect)(() => () => {
          ...
          g(() => {
            if ((y && (y.current = $.current), $.current))
              return (
          ...
          i.createElement(
            t,
            v({ ref: $, className: c(`${C}${e ? ` ${e}` : ''}`) }, G),
            R['container-start'],
            l(D) &&
              i.createElement(
                i.Fragment,
                null,
                i.createElement('div', { ref: I, className: 'swiper-button-prev' }),
                i.createElement('div', { ref: z, className: 'swiper-button-next' })
              ),
      ...
      const y = (0, i.forwardRef)(
        ({ tag: e = 'div', children: t, className: s = '', swiper: n, zoom: r, virtualIndex: a, ...l } = {}, o) => {
          ...
          return i.createElement(
            e,
            b({ ref: d, className: c(`${p}${s ? ` ${s}` : ''}`), 'data-swiper-slide-index': a }, l),
            r
              ? i.createElement('div', { className: 'swiper-zoom-container', 'data-swiper-zoom': 'number' === typeof r ? r : void 0 }, m())
              : m()
          )
        }
      )
    ...
    3850: function (e, t, s) {
        ...
        off: function (...e) {
          ...
          for (let a = 0; a < r.length; a += 1) {
            ...
            for (let t = 0; t < this.length; t += 1) {
              ...
              let a
              if (
                (!s && r.dom7Listeners ? (a = r.dom7Listeners[e]) : s && r.dom7LiveListeners && (a = r.dom7LiveListeners[e]), a && a.length)
              )
      ...
      function b(e, t = 'x') {
        ...
        const a = (function (e) {
          ...
          let s
          return (
            t.getComputedStyle && (s = t.getComputedStyle(e, null)), !s && e.currentStyle && (s = e.currentStyle), s || (s = e.style), s
          )
        })(e)
        return (
          s.WebKitCSSMatrix
      ...
      function z(e) {
        ...
        if (!s.allowTouchMove)
          return (
            (s.allowClick = !1),
            void (i.isTouched && (Object.assign(r, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = w())))
          )
        ...
        if (
          ...
          m > 0 && i.currentTranslate > s.minTranslate()
            ...
            : m < 0 &&
              ...
              ((v = !1), n.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - m) ** b)),
      ...
      function I(e) {
        ...
        if (c > i.longSwipesMs) {
          ...
          'next' === t.swipeDirection && (h >= i.longSwipesRatio ? t.slideTo(u + m) : t.slideTo(u)),
            'prev' === t.swipeDirection && (h > 1 - i.longSwipesRatio ? t.slideTo(u + m) : t.slideTo(u))
        } else {
          ...
          update: {
            ...
            updateSlides: function () {
              ...
              'string' === typeof b && b.indexOf('%') >= 0 && (b = (parseFloat(b.replace('%', '')) / 100) * r),
                ...
                i.centeredSlides &&
                  i.cssMode &&
                  (C(e.wrapperEl, '--swiper-centered-offset-before', ''), C(e.wrapperEl, '--swiper-centered-offset-after', ''))
              ...
              const M =
                ...
                i.breakpoints &&
                Object.keys(i.breakpoints).filter(e => 'undefined' !== typeof i.breakpoints[e].slidesPerView).length > 0
              for (let C = 0; C < p; C += 1) {
                x = 0
                const n = c.eq(C)
                if ((T && e.grid.updateSlide(C, n, p, t), 'none' !== n.css('display'))) {
                  if ('auto' === i.slidesPerView) {
                    M && (c[C].style[t('width')] = '')
                    const r = getComputedStyle(n[0]),
                      a = n[0].style.transform,
                      l = n[0].style.webkitTransform
                    if ((a && (n[0].style.transform = 'none'), l && (n[0].style.webkitTransform = 'none'), i.roundLengths))
              ...
              if (
                (Object.assign(e, { slides: c, snapGrid: u, slidesGrid: f, slidesSizesGrid: h }),
            ...
            updateSlidesProgress: function (e = (this && this.translate) || 0) {
              ...
              for (let l = 0; l < i.length; l += 1) {
                ...
                ;((p >= 0 && p < t.size - 1) || (u > 1 && u <= t.size) || (p <= 0 && u >= t.size)) &&
                  (t.visibleSlides.push(e), t.visibleSlidesIndexes.push(l), i.eq(l).addClass(s.slideVisibleClass)),
                  (e.progress = n ? -d : d),
            ...
            updateClickedSlide: function (e) {
              ...
              ;(t.clickedSlide = i),
                t.virtual && t.params.virtual.enabled
                  ? (t.clickedIndex = parseInt(g(i).attr('data-swiper-slide-index'), 10))
                  : (t.clickedIndex = n),
            ...
            translateTo: function (e = 0, t = this.params.speed, s = !0, i = !0, n) {
              ...
              if (((c = i && e > o ? o : i && e < d ? d : e), r.updateProgress(c), a.cssMode)) {
                ...
                if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c
                  ...
                  if (!r.support.smoothScroll) return E({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0
          ...
          slide: {
            ...
            slidePrev: function (e = this.params.speed, t = !0, s) {
              ...
              return (
                ...
                n.rewind && i.isBeginning ? i.slideTo(i.slides.length - 1, e, t, s) : i.slideTo(h, e, t, s)
              )
            },
          ...
          events: {
            attachEvents: function () {
              ...
              ;(e.onTouchStart = _.bind(e)),
                ...
                (e.onClick = N.bind(e)),
                i.touch && !B && (t.addEventListener('touchstart', G), (B = !0)),
                j(e, 'on')
            },
          ...
          images: {
            loadImage: function (e, t, s, i, n, r) {
              ...
              g(e).parent('picture')[0] || (e.complete && n)
                ? d()
                : t
                ? ((l = new a.Image()), (l.onload = d), (l.onerror = d), i && (l.sizes = i), s && (l.srcset = s), t && (l.src = t))
                : d()
            },
      ...
      class q {
        constructor(...e) {
          ...
          const n = {}
          i.modules.forEach(e => {
            e({ swiper: i, extendParams: H(s, n), on: i.on.bind(i), once: i.once.bind(i), off: i.off.bind(i), emit: i.emit.bind(i) })
          })
          const r = S({}, R, n)
          return (
            (i.params = S({}, r, W, s)),
      ...
      function K({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        function d() {
          ...
          if (
            (e.params.loop
              ...
              : (c = 'undefined' !== typeof e.snapIndex ? e.snapIndex : e.activeIndex || 0),
            ...
            if (
              ...
              i.each(e => {
                ...
                i === c && t.addClass(s.bulletActiveClass),
                  s.dynamicBullets &&
                    (i >= n && i <= l && t.addClass(`${s.bulletActiveClass}-main`), i === n && o(t, 'prev'), i === l && o(t, 'next'))
              })
            else {
              const t = i.eq(c),
                r = t.index()
          ...
          if (
            ('fraction' === s.type &&
              (d.find(U(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(U(s.totalClass)).text(s.formatFractionTotal(p))),
            'progressbar' === s.type)
          ) {
            let t
            ...
            'horizontal' === t ? (n = i) : (r = i),
              d.find(U(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed)
          }
        ...
        function p() {
          ...
          0 !== s.length &&
            (e.params.uniqueNavElements &&
              'string' === typeof t.el &&
              s.length > 1 &&
              ((s = e.$el.find(t.el)), s.length > 1 && (s = s.filter(t => g(t).parents('.swiper')[0] === e.el))),
            'bullets' === t.type && t.clickable && s.addClass(t.clickableClass),
            s.addClass(t.modifierClass + t.type),
            s.addClass(t.modifierClass + e.params.direction),
            'bullets' === t.type &&
              t.dynamicBullets &&
              (s.addClass(`${t.modifierClass}${t.type}-dynamic`), (a = 0), t.dynamicMainBullets < 1 && (t.dynamicMainBullets = 1)),
            'progressbar' === t.type && t.progressbarOpposite && s.addClass(t.progressbarOppositeClass),
            t.clickable &&
              s.on('click', U(t.bulletClass), function (t) {
                t.preventDefault()
        ...
        function u() {
          ...
          s.removeClass(t.hiddenClass),
            ...
            t.clickable && s.off('click', U(t.bulletClass))
        }
        s('init', () => {
          p(), c(), d()
        }),
          ...
          s('click', (t, s) => {
            ...
            if (
              ...
              if (
                e.navigation &&
                ((e.navigation.nextEl && n === e.navigation.nextEl) || (e.navigation.prevEl && n === e.navigation.prevEl))
              )
                return
          ...
          s('init', () => {
            if (e.params.autoplay.enabled) {
              ...
              a().addEventListener('visibilitychange', c),
                e.params.autoplay.pauseOnMouseEnter && (e.$el.on('mouseenter', u), e.$el.on('mouseleave', f))
            }
          }),
      ...
      function Q({ swiper: e, extendParams: t, emit: s, once: i }) {
        t({
          freeMode: {
            enabled: !1,
            momentum: !0,
            ...
            freeMode: {
              onTouchMove: function () {
                ...
                0 === t.velocities.length &&
                  ...
                  t.velocities.push({ position: s[e.isHorizontal() ? 'currentX' : 'currentY'], time: w() })
              },
              onTouchEnd: function ({ currentPos: t }) {
                const { params: n, $wrapperEl: r, rtlTranslate: a, snapGrid: l, touchEventsData: o } = e,
                ...
                if (t < -e.minTranslate()) e.slideTo(e.activeIndex)
                  ...
                  if (n.freeMode.momentum) {
                    if (o.velocities.length > 1) {
                      ...
                      ;(e.velocity = i / r),
                        (e.velocity /= 2),
                        Math.abs(e.velocity) < n.freeMode.minimumVelocity && (e.velocity = 0),
                        (r > 150 || w() - t.time > 300) && (e.velocity = 0)
                    } else e.velocity = 0
                    ;(e.velocity *= n.freeMode.momentumVelocityRatio), (o.velocities.length = 0)
                    ...
                    let p,
                      u = !1
                    const f = 20 * Math.abs(e.velocity) * n.freeMode.momentumBounceRatio
                    let h
                    if (c < e.maxTranslate())
                      n.freeMode.momentumBounce
                        ? (c + e.maxTranslate() < -f && (c = e.maxTranslate() - f),
                          (p = e.maxTranslate()),
                          (u = !0),
                      ...
                      n.freeMode.momentumBounce
                        ? (c - e.minTranslate() > f && (c = e.minTranslate() + f),
                          (p = e.minTranslate()),
                          (u = !0),
                          (o.allowMomentumBounce = !0))
                        : (c = e.minTranslate()),
                    ...
                    if (
                      ...
                      if (
                        ((t = a ? Math.abs((-c - e.translate) / e.velocity) : Math.abs((c - e.translate) / e.velocity)), n.freeMode.sticky)
                      ) {
                        const s = Math.abs((a ? -c : c) - e.translate),
                          i = e.slidesSizesGrid[e.activeIndex]
                        t = s < i ? n.speed : s < 2 * i ? 1.5 * n.speed : 2.5 * n.speed
                      }
      ...
      function ee(e, t, s) {
        ...
        let r = n.children(`.${i}`)
        return r.length || ((r = g(`<div class="swiper-slide-shadow${s ? `-${s}` : ''}"></div>`)), n.append(r)), r
      }
      function te(e, t) {
      ...
      function se({ swiper: e, extendParams: t, on: s }) {
        ...
        !(function (e) {
          const { effect: t, swiper: s, on: i, setTranslate: n, setTransition: r, overwriteParams: a, perspective: l } = e
          i('beforeInit', () => {
          ...
          setTranslate: () => {
            ...
            for (let o = 0; o < t.length; o += 1) {
              ...
              d < 0 ? ((m = r.next), (h = !0)) : d > 0 && ((m = r.prev), (h = !0)),
                u.forEach((e, t) => {
                  u[t] = `calc(${e}px + (${i(m.translate[t])} * ${Math.abs(d * a)}))`
                }),
                f.forEach((e, t) => {
              ...
              if ((h && m.shadow) || !h) {
                ...
                if ((0 === e.length && m.shadow && (e = ee(r, s)), e.length)) {
                  const t = r.shadowPerProgress ? d * (1 / r.limitProgress) : d
                  e[0].style.opacity = Math.min(Math.max(Math.abs(t), 0), 1)
                }
              }
              const S = te(r, s)
              S.transform(y).css({ opacity: b }), m.origin && S.css('transform-origin', m.origin)
            }
          },
          setTransition: t => {
