  ...
  [4],
  {
      ...
      function a(e, i) {
        ...
        if (e && i && 'object' == typeof e && 'object' == typeof i) {
          ...
          if (r && e instanceof Map && i instanceof Map) {
            ...
            for (s = e.entries(); !(l = s.next()).done; ) if (!a(l.value[1], i.get(l.value[0]))) return !1
            return !0
          }
    ...
    722: function (e, t, r) {
      ...
      var o,
        ...
        i = (o = r(9590)) && o.__esModule ? o : { default: o },
        u = r(5741)
      function l() {
      ...
      var m = (function (e) {
        ...
        function u() {
          ...
          return (
            v(h((e = o.call.apply(o, [this].concat(r)))), 'mounted', !1),
            v(h(e), 'isReady', !1),
            v(h(e), 'isPlaying', !1),
            v(h(e), 'isLoading', !0),
            v(h(e), 'loadOnReady', null),
            v(h(e), 'startOnPlay', !0),
            v(h(e), 'seekOnPlay', null),
            v(h(e), 'onDurationCalled', !1),
            v(h(e), 'handlePlayerMount', function (t) {
            ...
            v(h(e), 'handleReady', function () {
              if (e.mounted) {
                ...
                r(),
                  ...
                  e.loadOnReady ? (e.player.load(e.loadOnReady, !0), (e.loadOnReady = null)) : n && e.player.play(),
            ...
            v(h(e), 'handlePlay', function () {
              ...
              var t = e.props,
                ...
                n = t.onPlay,
                o = t.playbackRate
              e.startOnPlay && (e.player.setPlaybackRate && 1 !== o && e.player.setPlaybackRate(o), r(), (e.startOnPlay = !1)),
                n(),
            ...
            v(h(e), 'handleDurationCheck', function () {
              ...
              var t = e.getDuration()
              t
                ? e.onDurationCalled || (e.props.onDuration(t), (e.onDurationCalled = !0))
                : (e.durationCheckTimeout = setTimeout(e.handleDurationCheck, 100))
            }),
                ...
                if (this.player) {
                  ...
                  if (!(0, i.default)(e.url, n)) {
                    if (this.isLoading && !f.forceLoad)
                      return (
                        console.warn('ReactPlayer: the attempt to load '.concat(n, ' is being deferred until the player has loaded')),
                        ...
                        window
                          ...
                          .then(function (e) {
                            if (e.thumbnail_url && t.mounted) {
                              ...
                              t.setState({ image: n }), (v[r] = n)
                            }
                          })
                      )
                    this.setState({ image: v[r] })
                ...
                value: function () {
                  var e = this.props,
                    ...
                    l = {
                      ...
                      shadow: u(
                        { background: 'radial-gradient(rgb(0, 0, 0, 0.3), rgba(0, 0, 0, 0) 60%)', borderRadius: b, width: b, height: b },
                        i
                      ),
                      playIcon: {
                        borderStyle: 'solid',
                    ...
                    c = o.default.createElement(
                      ...
                      o.default.createElement('div', { style: l.playIcon, className: 'react-player__play-icon' })
                    )
                  return o.default.createElement(
                    'div',
                    { style: l.preview, className: 'react-player__preview', onClick: t, tabIndex: n, onKeyPress: this.handleKeyPress },
                    r || c
                  )
                }
              }
    ...
    390: function (e, t, r) {
      ...
      t.createReactPlayer = function (e, t) {
        ...
        return (
          (s = r =
            (function (r) {
              ...
              function O() {
                ...
                return (
                  k(w((r = b.call.apply(b, [this].concat(s)))), 'state', { showPreview: !!r.props.light }),
                  k(w(r), 'references', {
                    wrapper: function (e) {
                      r.wrapper = e
                    },
                ...
                (f = [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return n.default.createElement(
                        u,
                        d({ ref: this.references.wrapper, style: y(y({}, r), {}, { width: o, height: a }) }, c),
                        n.default.createElement(M, { fallback: i }, l ? this.renderPreview(t) : this.renderActivePlayer(t))
                      )
                    }
                  }
                ]) && m(s.prototype, f),
          ...
          k(r, 'displayName', 'ReactPlayer'),
          k(r, 'propTypes', u.propTypes),
          k(r, 'defaultProps', u.defaultProps),
          k(r, 'addCustomPlayer', function (e) {
            A.push(e)
          }),
    ...
    6807: function (e, t, r) {
      ...
      var g = (function (e) {
        ...
        function l() {
          ...
          for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n]
          return (
            P(v((e = u.call.apply(u, [this].concat(r)))), 'callPlayer', a.callPlayer),
            P(v(e), 'onDurationChange', function () {
              var t = e.getDuration()
      ...
      var v = 'https://connect.facebook.net/en_US/sdk.js',
        ...
        g = (function (e) {
          ...
          function u() {
            ...
            for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n]
            return (
              b(d((e = i.call.apply(i, [this].concat(r)))), 'callPlayer', a.callPlayer),
              b(d(e), 'playerID', e.props.config.playerId || ''.concat(P).concat((0, a.randomString)())),
              b(d(e), 'mute', function () {
                e.callPlayer('mute')
              }),
            ...
            (r = [
              ...
              },
              {
                ...
                value: function (e) {
                  this.shouldUseAudio(this.props) !== this.shouldUseAudio(e) &&
                    (this.removeListeners(this.prevPlayer, e.url), this.addListeners(this.player)),
                    this.props.url === e.url || (0, a.isMediaStream)(this.props.url) || (this.player.srcObject = null)
                }
              },
              {
                key: 'componentWillUnmount',
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    this.shouldUseHLS(e) &&
                      (0, a.getSDK)('https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js'.replace('VERSION', n), 'Hls').then(
                        function (r) {
                          if (
                            ((t.hls = new r(o)),
                    ...
                    this.shouldUseDASH(e) &&
                      (0, a.getSDK)(
                        'https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js'.replace('VERSION', i),
                        'dashjs'
                      ).then(function (r) {
                        ;(t.dash = r.MediaPlayer().create()),
                          ...
                          parseInt(i) < 3
                            ...
                            : t.dash.updateSettings({ debug: { logLevel: r.Debug.LOG_LEVEL_NONE } }),
                          t.props.onLoaded()
                      }),
                    this.shouldUseFLV(e) &&
                      (0, a.getSDK)('https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js'.replace('VERSION', u), 'flvjs').then(
                        function (r) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (!(e instanceof Array || (0, a.isMediaStream)(e) || t || r || n))
    ...
    2648: function (e, t, r) {
      ...
      var m = (function (e) {
        ...
        function u() {
          ...
          for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n]
          return (
            v(h((e = i.call.apply(i, [this].concat(r)))), 'callPlayer', a.callPlayer),
            v(h(e), 'duration', null),
            v(h(e), 'currentTime', null),
      ...
      var v = 'twitch-player-',
        m = (function (e) {
          ...
          function y() {
            ...
            for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n]
            return (
              b(d((e = u.call.apply(u, [this].concat(r)))), 'callPlayer', a.callPlayer),
              b(d(e), 'playerID', e.props.config.playerId || ''.concat(v).concat((0, a.randomString)())),
              b(d(e), 'mute', function () {
                e.callPlayer('setMuted', !0)
              }),
              b(d(e), 'unmute', function () {
                  ...
                  t
                    ...
                    : (0, a.getSDK)('https://player.twitch.tv/js/embed/v1.js', 'Twitch').then(function (t) {
                        ...
                        r.player.addEventListener(i, r.props.onReady),
                          ...
                          r.player.addEventListener(y, r.props.onPause),
                          r.player.addEventListener(d, r.props.onEnded),
      ...
      var v = (function (e) {
        ...
        function u() {
          ...
          return (
            b(d((e = i.call.apply(i, [this].concat(r)))), 'callPlayer', a.callPlayer),
            b(d(e), 'duration', null),
            b(d(e), 'currentTime', null),
            b(d(e), 'secondsLoaded', null),
            b(d(e), 'mute', function () {
              e.setVolume(0)
            }),
            b(d(e), 'unmute', function () {
      ...
      var m = 'wistia-player-',
        P = (function (e) {
          ...
          function l() {
            ...
            return (
              v(h((e = u.call.apply(u, [this].concat(r)))), 'callPlayer', a.callPlayer),
              v(h(e), 'playerID', e.props.config.playerId || ''.concat(m).concat((0, a.randomString)())),
      ...
      var g = 'YT',
        ...
        k = (function (e) {
          ...
          function l() {
            ...
            return (
              P(v((e = u.call.apply(u, [this].concat(r)))), 'callPlayer', a.callPlayer),
              P(v(e), 'parsePlaylist', function (t) {
                return t instanceof Array
                  ? { listType: 'playlist', playlist: t.map(e.getID).join(',') }
                  : O.test(t)
                  ? { listType: 'playlist', list: s(t.match(O), 2)[1].replace(/^UC/, 'UU') }
                  : w.test(t)
      ...
      var c = [
        ...
        },
        {
          ...
          canEnablePIP: function (e) {
            return (
              a.canPlay.file(e) &&
              (document.pictureInPictureEnabled || (0, o.supportsWebKitPresentationMode)()) &&
    ...
    5741: function (e, t, r) {
      ...
      var h = function () {},
        b = {
          ...
          config: {
            soundcloud: {
              options: { visual: !0, buying: !1, liking: !1, download: !1, sharing: !1, show_comments: !1, show_playcount: !1 }
            },
            youtube: {
            ...
            vimeo: { playerOptions: { autopause: !1, byline: !1, portrait: !1, title: !1 } },
            file: {
              attributes: {},
              tracks: [],
              forceVideo: !1,
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.callPlayer = function (e) {
          ...
          if (!this.player || !this.player[e]) {
            ...
            return (
              this.player ? this.player[e] || (r += 'The method was not available') : (r += 'The player was not available'),
