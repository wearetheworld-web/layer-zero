!(function () {
    ...
    et = e(function (t) {
      ...
      ;(t.exports = function (t, e, i, a) {
        var u = !!a && !!a.unsafe,
          ...
          c = !!a && !!a.noTargetGet
        'function' == typeof i &&
          ('string' != typeof e || b(i, 'name') || I(i, 'name', e), (r(i).source = o.join('string' == typeof e ? e : ''))),
          t !== n ? (u ? !c && t[e] && (s = !0) : delete t[e], s ? (t[e] = i) : I(t, e, i)) : s ? (t[e] = i) : T(e, i)
  ...
  var Ht =
      ...
      function (t, e) {
        var r
        return (
          null !== t ? ((Gt.prototype = R(t)), (r = new Gt()), (Gt.prototype = null), (r[Kt] = t)) : (r = Vt()), void 0 === e ? r : zt(r, e)
        )
      },
    Xt = Dt('unscopables'),
    Yt = Array.prototype
  ...
  var re =
    ...
    ae = function (t) {
      ...
      return function (u, s, c, f) {
        for (
          var l, h, d = Lt(u), v = p(d), g = Zt(s, c, 3), y = ct(v.length), m = 0, b = f || oe, w = e ? b(u, y) : r ? b(u, 0) : void 0;
          y > m;
          m++
        )
  ...
  var Le = { IteratorPrototype: Se, BUGGY_SAFARI_ITERATORS: ke },
    ...
    Xe = function (t, e, r, n, o, i, a) {
      ...
      if (
        ...
        if (((s = { values: f($e), keys: i ? v : f(Ge), entries: f(Ve) }), a)) for (c in s) (We || h || !(c in p)) && et(p, c, s[c])
        ...
        var o = t(function (t, a) {
          ...
          u = function (t, e, r) {
            ...
            return (
              c
                ? (c.value = r)
                : ((u.last = c = { index: (o = zr(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1 }),
                  u.first || (u.first = c),
                  n && (n.next = c),
                  i ? u.size++ : t.size++,
                  'F' !== o && (u.index[o] = c)),
  ...
  var cn = function (t, e) {
    ...
    return (
      n.has(t) ? ((r = n.get(t)), 'function' == typeof e && ((r = e(r)), n.set(t, r))) : 'function' == typeof o && ((r = o()), n.set(t, r)),
      r
    )
  }
      ...
      if (!a || !u || ('replace' === t && (!Ti || !ki || Ui)) || ('split' === t && !Mi)) {
        var s = /./[i],
          c = r(
            ...
            ''[t],
            function (t, e, r, n, o) {
              return e.exec === Ei ? (a && !o ? { done: !0, value: s.call(e, r, n) } : { done: !0, value: t.call(r, e, n) }) : { done: !1 }
            },
            ...
            ? function (t, r) {
                ...
                for (
                  var i,
                    ...
                    f = new RegExp(
                      t.source,
                      (t.ignoreCase ? 'i' : '') + (t.multiline ? 'm' : '') + (t.unicode ? 'u' : '') + (t.sticky ? 'y' : '') + 'g'
                    );
                  (i = Ei.call(f, n)) &&
                  !(
                    (a = f.lastIndex) > c &&
        ...
        [
          ...
          function (t, o) {
            ...
            var a = R(t),
              ...
              f = new s(
                Vi ? a : '^(?:' + a.source + ')',
                (a.ignoreCase ? 'i' : '') + (a.multiline ? 'm' : '') + (a.unicode ? 'u' : '') + (Vi ? 'y' : 'g')
              ),
              l = void 0 === o ? $i : o >>> 0
            if (0 === l) return []
        ...
        if (g(c))
          if ('function' == typeof (t = lr(c)))
            for (r = (e = t.call(c)).next; !(n = r.call(e)).done; ) {
              if ((a = (i = (o = on(R(n.value))).next).call(o)).done || (u = i.call(o)).done || !i.call(o).done)
  ...
  var vs,
    ...
    zs = function (t) {
      ...
      if ('object' == typeof t) {
        for (
          ...
          (o && 0 === t[r]) ||
            (o && (o = !1), n === r ? ((e += r ? ':' : '::'), (o = !0)) : ((e += t[r].toString(16)), r < 7 && (e += ':')))
        return '[' + e + ']'
      }
      return t
    },
      ...
      for (
        ...
        switch (((i = o[f]), c)) {
          ...
          case gc:
            ...
            n && 'file' == n.scheme && !Zs(o.slice(f).join('')) && (Qs(n.path[0], !0) ? t.path.push(n.path[0]) : (t.host = n.host)),
              (c = bc)
            continue
          case yc:
            if (i == vs || '/' == i || '\\' == i || '?' == i || '#' == i) {
            ...
            if (i == vs || '/' == i || ('\\' == i && Xs(t)) || (!r && ('?' == i || '#' == i))) {
              if (
                ('..' === (s = (s = l).toLowerCase()) || '%2e.' === s || '.%2e' === s || '%2e%2e' === s
                  ...
                  : ('file' == t.scheme && !t.path.length && Qs(l) && (t.host && (t.host = ''), (l = l.charAt(0) + ':')), t.path.push(l)),
                (l = ''),
          ...
          case Sc:
            r || '#' != i
              ? i != vs && ("'" == i && Xs(t) ? (t.query += '%27') : (t.query += '#' == i ? '%23' : Vs(i, Ws)))
              : ((t.fragment = ''), (c = Ec))
            break
          case Ec:
    ...
    Rc = function () {
      ...
      return (
        null !== o
          ? ((c += '//'), Ys(t) && (c += r + (n ? ':' + n : '') + '@'), (c += zs(o)), null !== i && (c += ':' + i))
          : 'file' == e && (c += '//'),
    ...
    (i &&
      zt(Oc, {
        ...
        search: Fc(_c, function (t) {
          var e = Es(this)
          '' == (t = String(t)) ? (e.query = null) : ('?' == t.charAt(0) && (t = t.slice(1)), (e.query = ''), xc(e, t, Sc)),
            ws(e.searchParams).updateSearchParams(e.query)
        }),
        searchParams: Fc(Nc),
  ...
  ;(Vc && Hc) ||
    ...
    'process' == l(Xc)
      ...
      : !n.addEventListener || 'function' != typeof postMessage || n.importScripts || o(nf) || 'file:' === $c.protocol
      ? (qc =
  ...
  var Ef,
    ...
    Jf = function (t, e, r) {
      var o, i
      Gf
        ? (((o = Bf.createEvent('Event')).promise = e), (o.reason = r), o.initEvent(t, !1, !0), n.dispatchEvent(o))
  ...
  Vf &&
    ...
    ((Ef = function (t) {
      _f(this, { type: Uf, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
  ...
  var il = tt.set,
    ...
    ul = function (t, e) {
      ...
      var n = []
      return (
        Mr(t, n.push, n), i ? il(r, { errors: n, type: 'AggregateError' }) : (r.errors = n), void 0 !== e && I(r, 'message', String(e)), r
      )
    }
        ...
        ;(this._bodyInit = t),
          t
            ? 'string' == typeof t
              ...
              ? ((this._bodyArrayBuffer = xl(t.buffer)), (this._bodyInit = new Blob([this._bodyArrayBuffer])))
  ...
  ;(Rl.prototype.clone = function () {
    ...
    (Pl.prototype.clone = function () {
      return new Pl(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new bl(this.headers), url: this.url })
    }),
    (Pl.error = function () {
