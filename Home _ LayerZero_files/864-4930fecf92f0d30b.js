    ...
    5448: function (e, t, n) {
      ...
      e.exports = function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            (g.open(e.method.toUpperCase(), s(x, e.params, e.paramsSerializer), !0),
            (g.timeout = e.timeout),
            'onloadend' in g
              ? (g.onloadend = E)
            ...
            var S = (e.withCredentials || c(x)) && e.xsrfCookieName ? i.read(e.xsrfCookieName) : void 0
      ...
      e.exports = function (e) {
        return (
          ...
          (e.adapter || s.adapter)(e).then(
            ...
            function (t) {
              return (
                i(t) || (u(e), t && t.response && (t.response.data = o.call(e, t.response.data, t.response.headers, e.transformResponse))),
                Promise.reject(t)
              )
            }
          )
        ...
        adapter: (function () {
          ...
          return (
            ('undefined' !== typeof XMLHttpRequest ||
              ('undefined' !== typeof r && '[object process]' === Object.prototype.toString.call(r))) &&
              (e = n(5448)),
            e
          )
        })(),
    ...
    4875: function (e, t, n) {
      ...
      ;(o.transitional = function (e, t, n) {
        ...
        return function (n, r, s) {
          ...
          return (
            t && !i[r] && ((i[r] = !0), console.warn(o(r, ' has been deprecated since v' + t + ' and will be removed in the near future'))),
            !e || e(n, r, s)
          )
        }
      }),
